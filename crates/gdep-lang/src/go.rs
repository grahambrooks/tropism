...
mod tests {
    ...
    fn classify(file: &str, source: &str) -> gdep_core::graph::ModuleId {
    ...
    fn ordinary_files_are_normal_modules() {
        ...
        assert_eq!(id, gdep_core::graph::ModuleId::module("api"));
    }

    #[test]
    fn in_package_test_files_are_internal_test_modules() {
        let id = classify("api/api_test.go", "package api\n");
        assert_eq!(id, gdep_core::graph::ModuleId::internal_test("api"));
    }
    ...
    fn external_test_packages_are_their_own_kind() {
        ...
        assert_eq!(id, gdep_core::graph::ModuleId::external_test("api"));
    }
